...
urlpatterns = [
    ...
    path("quiz_detail/<int:quiz_id>/", views.quiz_detail, name="quizz_detail"),
    path("quiz/<int:quiz_id>/", views.quiz_take, name="quiz_take"),
    path("quiz/result/<int:attempt_id>/", views.quiz_result, name="quizz_result"),
    ...
    path("explore/<str:filter_type>/", views.explore, name="explore_filter"),
